...
- [ ] [2022] RQ-VAE & RQ-Transformer: Autoregressive Image Generation using Residual Quantization — [paper](https://arxiv.org/abs/2203.01941)
...
- **Methods**:
  ...
  - **(2) RQ-Transformer**:
    - Instead of the AR model predicting next token in the raster-scan-order flattened sequence of discrete codes, predict the next $Q$ tokens, where $Q$ is the number of quantizers/levels in RVQ.
